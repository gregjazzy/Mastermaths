...
// GET : Récupérer toutes les questions d'un exercice
export async function GET(
  ...
  try {
    ...
    console.error('[QCM EXERCISE GET ERROR]', error)
    return NextResponse.json({ error: 'Erreur serveur' }, { status: 500 })
  }
}

// POST : Créer une nouvelle question pour un exercice
export async function POST(
  ...
  try {
    ...
    console.error('[QCM EXERCISE POST ERROR]', error)
    return NextResponse.json({ error: 'Erreur serveur' }, { status: 500 })
  }
}
